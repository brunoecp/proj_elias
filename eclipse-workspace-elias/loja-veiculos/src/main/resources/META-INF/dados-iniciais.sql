...
values ('Fernando Martins', '34 9 1111 1111');
insert into proprietario (nome, telefone)
values ('Isabela Santos', '34 9 2222 2222');
insert into proprietario (nome, telefone)
values ('Ulisses Silva', '34 9 3333 3333');
commit;

insert into tab_veiculo (fabricante, modelo, ano_fabricacao,
ano_modelo, valor, tipo_combustivel, data_cadastro, proprietario_codigo)
values ( 'Fiat', 'Toro', 2020, 2020, 107000, 'DIESEL', sysdate(), 1);
insert into tab_veiculo (fabricante, modelo, ano_fabricacao,
ano_modelo, valor, tipo_combustivel, data_cadastro, proprietario_codigo)
values ('Ford', 'Fiesta', 2019, 2019, 42000, 'GASOLINA', sysdate(), 2);
insert into tab_veiculo (fabricante, modelo, ano_fabricacao,
ano_modelo, valor, tipo_combustivel, data_cadastro, proprietario_codigo)
values ('VW', 'Gol', 2019, 2020, 35000, 'BICOMBUSTIVEL', sysdate(), 3);
commit;
